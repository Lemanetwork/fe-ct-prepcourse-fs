...
function nuevoUsuario(nombre, email, password) {
   ...
   // Retornar el objeto.
   // Tu código:
   var nUsuario = {nombre: nombre, email: email, password: password};
   return nUsuario;
}
...
function tieneEmail(objetoUsuario) {
   ...
   // Tu código:
   if(objetoUsuario.email === null || objetoUsuario.email === undefined) return false;
   else return true;
}
...
function pasarUsuarioAPremium(objetoMuchosUsuarios) {
   ...
   // Retornar el arreglo.
   // Tu código:
   objetoMuchosUsuarios.forEach((usr) => {usr.esPremium = true;});
